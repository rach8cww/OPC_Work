"""
__init___.py file with added statements to check the location of bugs preventing the histogram from compiling...
"""

# Import libraries and exceptions
...
class _OPC(object):
    ...
    def __init__(self, spi_connection, firmware=None, **kwargs):
        ...
        # Flow check
        print('Reached line 72, firmware connection established')
...
class OPCN2(_OPC):
    ...
    def config2(self):
        ...
        **NOTE: This method is supported by firmware v18+.**
        ...
        # Send the command byte and sleep for 10 ms
        self.cnxn.xfer([0x3D])
        sleep(60) # ADDED, makes the sampling time longer ?
        # sleep(10e-3)
    ...
    def histogram(self, number_concentration=True):
        print('Initiating the Histogram Protocol')
